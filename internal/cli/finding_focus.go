...
var sessionFocusCategories = map[string]map[string]bool{
	"tooling": {
		...
		"recovery-loop":           true,
		"tooling-bypass":          true,
		"help-effectiveness":      true,
		"verification-escalation": true,
		"search-inefficiency":     true,
...
var preferredSessionFindingFocus = map[string]string{
	...
	"tooling-bypass":          "interface",
	"help-effectiveness":      "interface",
	"verification-escalation": "loops",
	"search-inefficiency":     "discovery",
